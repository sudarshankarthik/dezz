  ...
  return (
    ...
    <div className="row flex-lg-row align-items-center g-5 py-5">
      ...
      <div className="col-12 col-md-7 xl-6">
        <h2 className="display-6 fw-bold lh-1 mb-3">Welcome to our online store for premium t-shirts, shirts, and hoodies!</h2>
      ...
      <div className='row flex-lg-row align-items-center justify-content-center g-5 py-5'>
        <div className='col-12 col-md-3'>
              ...
              <Card.Body>
                ...
                <Button variant="primary">Shop Our T-shirt Collection</Button>
              </Card.Body>
              </Card.ImgOverlay>
              </Card>
        </div>
        <div className='col-12 col-md-3'>
              ...
              <Card.Body>
                ...
                <Button variant="primary">Shop Our Shirt Collection</Button>
              </Card.Body>
              </Card.ImgOverlay>
              </Card>
        </div>
        <div className='col-12 col-md-3'>
              ...
              <Card.Body>
                ...
                <Button variant="primary">Shop Our Hoodie Collectione</Button>
              </Card.Body>
              </Card.ImgOverlay>
              </Card>
        </div>
